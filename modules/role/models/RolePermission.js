  ...
  const RolePermission = sequelize.define(
    "RolePermission",
    {
      ...
      moduleName: {
        ...
        allowNull: false,
        comment:
          'Module the resource lives in e.g. "employee", "leave", "payroll"',
      },
      resourceName: {
        type: DataTypes.STRING(100),
        allowNull: false,
        comment:
          'DocType name e.g. "Employee", "LeaveApplication", "SalarySlip"',
      },
      ...
      canReadSelf: {
        ...
        allowNull: true,
        defaultValue: true,
        comment: "Can read own records only (self-service)",
      },
      ...
      canSetPermissions: {
        ...
        defaultValue: false,
        comment:
          "Whether this role can grant UserPermission records to other users",
      },
    },
    {
      tableName: "role_permissions",
      comment:
        "One rule: Role X can perform action set Y on ResourceName Z at permLevel N",
      indexes: [
        {
