  ...
  const AppraisalCycle = sequelize.define(
    "AppraisalCycle",
    {
      ...
      appraisalTemplateId: {
        ...
        allowNull: false,
        comment:
          "FK → appraisal_templates.id — all KRAs, criteria and weights inherited from here",
      },
      ...
      name: {
        ...
        allowNull: false,
        comment:
          'e.g. "FY 2025 Annual Appraisal — Engineering", "Q3 2025 Sales Review"',
      },
      cycleType: {
        ...
        validate: {
          isIn: {
            ...
            msg: "Cycle type must be one of Annual, Quarterly, Half-Yearly, Monthly",
          },
        },
        comment:
          "Determines frequency and default milestone deadlines; does not affect functionality",
      },
      ...
      status: {
        ...
        validate: {
          isIn: {
            ...
            msg: "Status must be one of Draft, Launched, Completed",
          },
        },
        comment:
          "Controls which actions are available at each stage of the cycle",
      },
      ...
      completedAppraisals: {
        ...
        defaultValue: 0,
        comment:
          "Count of Appraisals where status = Completed — updated by trigger/service",
      },
    ...
    },
    {
      ...
      comment:
        "A time-boxed performance review cycle — bulk-creates one Appraisal per matched employee on launch",
      indexes: [
        {
          fields: ["appraisal_template_id"],
          name: "idx_appraisal_cycles_template",
        },
        { fields: ["status"], name: "idx_appraisal_cycles_status" },
        {
          fields: ["start_date", "end_date"],
          name: "idx_appraisal_cycles_window",
        },
