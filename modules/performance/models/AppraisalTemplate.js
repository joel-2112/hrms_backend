...
module.exports = (sequelize, DataTypes) => {
  const AppraisalTemplate = sequelize.define('AppraisalTemplate', {
    id: {
      type:         DataTypes.UUID,
    ...
    name: {
      ...
      allowNull: false,
      unique:    true,
      comment:   'e.g. "Engineering Annual Review", "Management 360°", "Sales Quarterly"',
    },
    description: {
      type:      DataTypes.TEXT,
      allowNull: true,
    ...
    designationId: {
      type:      DataTypes.UUID,
      allowNull: true,
      comment:   'FK → designations.id — soft link; null = template applies to all designations',
    },
    ...
    scoringMethod: {
      type:      DataTypes.ENUM(
        ...
        'Manual'              // HR enters the final score directly on Appraisal
      ),
      allowNull:    false,
    ...
    ratingScale: {
      ...
      allowNull:    false,
      defaultValue: 5,
      comment:      'Maximum score per goal / KRA e.g. 5 = ratings 1–5, 10 = ratings 1–10',
    },
    ...
    goalWeightPct: {
      ...
      allowNull:    false,
      defaultValue: 70.00,
      comment:      'Percentage weight of manager-rated goal scores in final score',
    },
    selfAppraisalWeightPct: {
      type:         DataTypes.DECIMAL(5, 2),
      allowNull:    false,
      defaultValue: 15.00,
      comment:      'Percentage weight of employee self-appraisal score in final score',
    },
    feedbackWeightPct: {
      type:         DataTypes.DECIMAL(5, 2),
      allowNull:    false,
      defaultValue: 15.00,
      comment:      'Percentage weight of 360° peer/subordinate feedback in final score',
    },
    ...
    kras: {
      ...
      allowNull:    false,
      defaultValue: [],
      comment:      'KRA definitions with weightages and per-score rating descriptors',
    },
    ...
    feedbackCriteria: {
      ...
      allowNull:    false,
      defaultValue: [],
      comment:      'Structured 360° feedback criteria — keyed by criterionId in EmployeePerformanceFeedback',
    },
    ...
    enableSelfAppraisal: {
      ...
      allowNull:    false,
      defaultValue: true,
      comment:      'When true the employee fills in their own goal scores before manager review',
    },
    ...
    minFeedbackResponses: {
      ...
      allowNull:    false,
      defaultValue: 2,
      comment:      'Minimum number of peer responses needed before feedbackScore is computed',
    },
    ...
    showScoresToEmployee: {
      ...
      allowNull:    false,
      defaultValue: false,
      comment:      'When false the employee sees feedback qualitative text but not numeric scores',
    },
    showFeedbackReviewerNames: {
      type:         DataTypes.BOOLEAN,
      allowNull:    false,
      defaultValue: false,
      comment:      'When false peer reviewer identities are hidden — anonymous 360°',
    },
    ...
    comment:   'Governs the structure, scoring formula, KRAs, and feedback criteria of every appraisal cycle that uses it',
  });
