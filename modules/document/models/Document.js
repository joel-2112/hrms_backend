...
module.exports = (sequelize, DataTypes) => {
  const Document = sequelize.define('Document', {
    ...
    documentNumber: {
      ...
      allowNull: true,
      comment:   'Official document reference number e.g. ID number, passport number',
    },
    ...
    filePath: {
      ...
      allowNull: false,
      comment:   'Server-side path relative to uploads/ root e.g. "documents/uuid.pdf"',
    },
    mimeType: {
      type:      DataTypes.STRING(100),
      allowNull: true,
      comment:   'MIME type detected at upload e.g. "application/pdf", "image/jpeg"',
    },
    fileSizeKb: {
    ...
    tableName: 'documents',
    comment:   'An uploaded file attached to an employee — the live / current version',
    indexes: [
